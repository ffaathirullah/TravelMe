  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row',  alignItems: 'center', justifyContent: 'center', marginTop: 39, marginLeft: 54}}>
        ...
        <View style={{width: 124, height:58 , elevation: 3}}>
          <TouchableOpacity style={{width: 124, height:58 , elevation: 3}}><Text style={{fontSize: 16, fontWeight: 'bold',}}>Dibatalkan</Text></TouchableOpacity>
        </View>
        <View style={{width: 124, height:58 , elevation: 3}}>
          <TouchableOpacity style={{width: 124, height:58, elevation: 3}}><Text style={{fontSize: 16, fontWeight: 'bold',}}>Selesai</Text></TouchableOpacity>
        </View>
    </View>
