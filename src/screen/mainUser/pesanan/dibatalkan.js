...
export default function dibatalkan({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row',  alignItems: 'center', justifyContent: 'center', marginTop: 39, marginLeft: 54}}>
        ...
        <View style={{width: 124, height:58 , elevation: 3}}>
          <TouchableOpacity><Text style={{fontSize: 16, fontWeight: 'bold',}} onPress={() => navigation.navigate('pesananRouter')}>Dipesan</Text></TouchableOpacity>
        </View>
        <View style={{width: 124, height:58 , elevation: 3}}>
    ...
    <View style={{width: 343, height:80 , elevation: 3, marginTop:24,  marginLeft: 17, marginRight: 17, flexDirection: 'row'}}>
      ...
      <View>
        <TouchableOpacity style={{backgroundColor: '#EBEFEF', width: 75, height: 22, marginLeft: 117}}><Text style={{alignSelf: 'center'}}>Sudah Batalkan</Text></TouchableOpacity>
      </View>
    </View>
    </View>
  );
